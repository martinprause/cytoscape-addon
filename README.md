# Cytoscape Addon for Vaadin 14+ (based on npm)

This Vaadin addon wrappes [https://js.cytoscape.org/](https://js.cytoscape.org/) in a java component. It does not cover all features, but most of them an 
showcases how you can extent it on your own. 

This addon uses currently to cytoscape extensions:

* EdgeHandling: [https://github.com/cytoscape/cytoscape.js-edgehandles](https://github.com/cytoscape/cytoscape.js-edgehandles)
* ContextMenu: [https://github.com/cytoscape/cytoscape.js-cxtmenu](https://github.com/cytoscape/cytoscape.js-cxtmenu)

## Links
* Source code: [https://github.com/martinprause/cytoscape-addon](https://github.com/martinprause/cytoscape-addon)
* Vaadin directory: [https://vaadin.com/directory/component/cytoscape-addon](https://vaadin.com/directory/component/cytoscape-addon)
* Demo: [https://ctyoscapedemo.herokuapp.com/](https://ctyoscapedemo.herokuapp.com/)

## Running the demo application
Using `jetty:run` or by running the `de.xinblue.cytoscape.View` class (in src/text/java) directly from your IDE.
